  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "white", padding: "24px", borderRadius: "8px", minWidth: "400px", position: "relative" }}
      >
        <h2>{taskToEdit ? "Редагувати завдання" : "Нове завдання"}</h2>
        <button onClick={onClose} style={{ position: "absolute", top: "12px", right: "12px" }}>✕</button>
